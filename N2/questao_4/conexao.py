...
class ConexaoMongo:
    def connection():
        try:
            ...
            banco = client.crud #nome do banco = crud
            colecao = banco.mongo # nome da colecao = mongo
    ...
    def pesquisar(self, coluna, informacao):
        try:
            ...
            return colecao.find_one({coluna : informacao})
